...
var alien = "Orange";
if (alien === "Orange") {
    console.log("Good Shoot ".concat(alien, " alien! Congrats You Win 10 point"));
}
else if (alien === "red") {
    console.log("Normal Shoot ".concat(alien, " alien! Congrats You Win 5 point"));
}
else if (alien === "blue") {
    console.log("Exellent Shoot ".concat(alien, " alien! You Win 15 point"));
}
else {
